...
namespace DutchTreatAdvanced.Migrations
{
    ...
    [Migration("20210412032600_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2021, 4, 12, 3, 25, 59, 871, DateTimeKind.Utc).AddTicks(3188),
                            OrderNumber = "123456"
                        });
                });
            ...
            modelBuilder.Entity("DutchTreatAdvanced.Data.Entities.StoreUser", b =>
                {
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    b.HasOne("DutchTreatAdvanced.Data.Entities.StoreUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DutchTreatAdvanced.Data.Entities.StoreUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
